    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        body.light-mode .hero::before {
            background: linear-gradient(rgba(0, 0, 0, 0.4), rgba(0, 0, 0, 0.6)), url('{{ asset("images/hero-bg.jpg") }}');
        }
        ...
        body.light-mode .hero-subtitle { text-shadow: 0 0 10px rgba(0,0,0,0.8); }
        ...
        body.light-mode .hero-title { color: #ffffff; text-shadow: 0 5px 15px rgba(0,0,0,0.7); }
        ...
        body.light-mode .hero-desc { color: rgba(255,255,255,0.9); text-shadow: 0 2px 10px rgba(0,0,0,0.8); }
        ...
        .product-img-wrap img { position: absolute; top: 0; left: 0; width: 100%; height: 100%; object-fit: contain; background-color: #fff; padding: 20px; box-sizing: border-box; object-position: center; filter: brightness(0.9); transition: transform 0.8s cubic-bezier(0.2, 0, 0.2, 1), filter 0.5s ease; z-index: 2; opacity: 0; }
        ...
        .search-result-img { width: 40px; height: 40px; object-fit: contain; background-color: #fff; padding: 20px; box-sizing: border-box; border-radius: 6px; }
